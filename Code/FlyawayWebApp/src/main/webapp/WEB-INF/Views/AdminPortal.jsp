 ...
 <section class="container-fluid bg">
        <section class="row justify-content-center">
            ...
            <section class="col-sm-6 col-md-3">
                <form action="/FlyawayWebApp/adminLogin" method="get" class="form-container">
                    ...
                    <button type="submit" class="btn btn-success btn-block" value="Submit">Login</button>
                     ...
                     <div class="w3-display-centre w3-text-white">
                    	<c:if test="${not empty loginAdminError}">
   							${loginAdminError}
						</c:if>
                    </div>
                </form>
 ...
 <section class="container-fluid bg">
        <section class="row justify-content-center">
	         <div class="w3-display-centre w3-text-white" style="padding:28px">
	            <span class="w3-large">Not a registered User?</span><br>
	            <span class="w3-large">Register Below</span>
	        </div>
            <div class="row">
                <div class="col">
                    <h2 align="center" style="color:whitesmoke;"><b>New User Register</b></h2>
                    <br>
                </div>
            </div>
            <section class="col-sm-6 col-md-3">
                <form action="/FlyawayWebApp/createAdmin" method="post" class="form-container">
                    <div class="form-group mb-2">
                        <label for="inputEmail" class="sr-only">Email address</label>
                        <input type="email" name="email" class="form-control" id="inputEmail" aria-describedby="emailHelp" placeholder="Enter email"/>                      
                    </div>                    
                    ...
                    <div class="w3-display-centre w3-text-white" >
                    	<c:if test="${not empty createAdminError}" >
   							${createAdminError}
						</c:if>
                    </div>
                     <div  class="w3-display-centre w3-text-white">
                    	<c:if test="${not empty createAdminSuccessfull}">
   							msg: ${createAdminSuccessfull}
						</c:if>
                    </div>
                </form>
            </section>

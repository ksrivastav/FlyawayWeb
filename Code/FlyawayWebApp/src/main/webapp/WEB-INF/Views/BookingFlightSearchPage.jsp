...
<div class="w3-bar w3-white w3-card" id="myNavbar">
 ...
 <section class="container-fluid bg">
        ...
        <section class="row justify-content-center">
	         <div class="w3-display-centre w3-text-white" style="padding:28px">
	            <span class="w3-large">Search Flight</span><br>	            
	        </div>
            <div class="row">
            	<div class="col">
                    <h2 align="center" style="color:whitesmoke;"><b>Search Flight</b></h2>
                    <br>
                </div>                
            </div>
            <section class="col-sm-6 col-md-3">
                <form action="/FlyawayWebApp/searchFlight" method="get" class="form-container"  style="color:whitesmoke;">                    
	                <table border ="1">
		                <tr>			                
			                <th>
			                	Departure Airport
		    				...
		    				<tr>
		    					<td><select class="form-control" id="depAirportid" name="depAirportId" >
								...
								<td>
									<select class="form-control" id="arrAirportId" name="arrAirportId"  >
								...
								<td>
                				<input type="text" name = "numOfPassenger" id="numOfPassengerSearch" class="btn btn-success btn-block" value="${numOfPassenger}"/>
                				</td>	  
								    							      				
		    				</tr>
		  					                	               	
	                </table>  
	                <button type="submit" class="btn btn-success btn-block" value="Submit">Search Flight</button>                		                      
                </form>
            </section>
            ...
            <section class="col-sm-6 col-md-3">
                <form action="/FlyawayWebApp/memberAccountDetails" method="get" class="form-container" style="color:whitesmoke;">
	                <table border ="1">
		                <tr><th>
		                	</th>			                
			                <th>
		                ...
		                <c:forEach items="${allAvailableFlightsData}" var="flight">
		    				...
		    				<tr>
		    					<td><input type="checkbox" id="flightId" name="flightId" value="${flight.flightId}"></td>
		      					<td><input type="text" id="flightNumber" name="flightNumber" value="${flight.flightNumber}" readonly/></td>
		      					<td><input type="text" id="localDepartureDateTime" name="localDepartureDateTime" value="${flight.localDepartureDateTime}" readonly /></td>
		      					<td><input type="text" id="localArrivalDateTime" name="localArrivalDateTime" value="${flight.localArrivalDateTime}" readonly/></td>		      						      				
		      					<td><input type="text" id="depAirportName" name="depAirportName" value="${flight.depAirportName}" readonly/></td>
		      					<td><input type="text" id="depCity" name="depCity" value="${flight.depCity}" readonly/></td>
		      					<td><input type="text" id="arrAirportName" name="arrAirportName" value="${flight.arrAirportName}" readonly/></td>
		      					<td><input type="text" id="arrCity" name="arrCity" value="${flight.arrCity}" readonly/></td>		      							      				
		    				</tr>
		  				</c:forEach>

...
<head>
    ...
    <title>Booking -> Reservation Details Page</title>
 ...
 <section class="container-fluid bg">
        <section class="row justify-content-center">
	         <div class="w3-display-centre w3-text-white" style="padding:28px">
	            <span class="w3-large">Booking -> Reservation Details Page</span><br>	            
	        </div>	        
	    </section>
	    
	    <div class="row">
                <div class="col">
                    <h2 align="center" style="color:whitesmoke;"><b>Your booking is confirmed</b></h2>
                    <h1 style="color:whitesmoke;"> Booking Number : "${BookingNumber}"</h1>
                    <br>
                </div>
            </div>
                ...
                <form action="/FlyawayWebApp/bookFlight" method="post" class="form-container" style="color:whitesmoke;">
	                <table border ="1">
		                <tr><th>
		    				...
		    				<tr>
		    					<td><c:out value="${BookedFlightData.flightId}"/></td>
		      					<td><c:out value="${BookedFlightData.flightNumber}" /></td>
		      					<td><c:out value="${BookedFlightData.localDepartureDateTime}" /></td>
		      					<td><c:out value="${BookedFlightData.localArrivalDateTime}" /></td>		      						      				
		      					<td><c:out value="${BookedFlightData.depAirportName}" /></td>
		      					<td><c:out value="${BookedFlightData.depCity}" /></td>
		      					<td><c:out value="${BookedFlightData.arrAirportName}" /></td>
		      					<td><c:out value="${BookedFlightData.arrCity}" /></td>		      							      				
		    				</tr>
